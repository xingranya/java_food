...
```
CREATE DATABASE IF NOT EXISTS java_food DEFAULT CHARSET utf8 COLLATE utf8_general_ci
```
...
![](https://raw.githubusercontent.com/geeeeeeeek/java_food/master/server/upload/image/a.png)


后台页面

![](https://raw.githubusercontent.com/geeeeeeeek/java_food/master/server/upload/image/b.png)
